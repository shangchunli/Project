                ...
                ,width:"100%",
                    ...
                    <List>
                        <List.Item style={{paddingTop:10,
                            color:"#000"}}>
                            <img src="./images/anxiety/anxiety1.jpg" style={{float:"right",
                    ...
                    <List style={{marginTop:10}}>
                        <List.Item style={{paddingTop:10}}>
                            <img src="./images/anxiety/anxiety2.jpg" style={{float:"right",
                                width:50,height:70,paddingBottom:10}}/>
                                产后焦虑症症状
                                <List.Item.Brief style={{color:"#000"}}>
                    ...
                    <List style={{marginTop:10}}>
                        <List.Item style={{paddingTop:10}}>
                            <img src="./images/anxiety/anxiety3.jpg" style={{float:"right",
                                width:50,height:70,paddingBottom:10}}/>
                                调节方法
                               <List.Item.Brief style={{color:"#000"}}
                    ...
                    <List style={{marginTop:10}}>
                        <List.Item style={{paddingTop:10}}>
                            <img src="./images/anxiety/anxiety4.jpg" style={{float:"right",
                                width:50,height:70,paddingBottom:10}}/>
                               注意事项
                                <List.Item.Brief style={{color:"#000"}}>
