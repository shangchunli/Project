...
import {Accordion,WingBlank ,Grid,Flex,List,NavBar,Icon} from 'antd-mobile';
import {withRouter} from 'react-router-dom'
import '../all.css'
class BYiyu extends Component {
    render() {
        return (
            <div style={{backgroundColor:'#fff',lineHeight:'2em',fontSize:16}}>
                <div style={{width:'90%',margin:'auto',}}>
                    <div style={{margin:'auto',width:'60%'}}>
                    <img style={{width:'100%'}}
                    src="https://i.loli.net/2020/05/18/WoydtGvhjqMkJZD.jpg"/>
                    </div>
                    <div style={{textIndent:'2em'}}>
                    准妈妈受身体或者心理产生变化的影响，如果期望和需要未被满足，容易诱发各种负面情绪，影响孕期健康。那么哪些孕妇易患产前抑郁？产前抑郁又有哪些表现？准妈妈应该如何走出和预防产前抑郁呢？
                    </div>
                    <div>
                        <Accordion defaultActiveKey="0" className="my-accordion" onChange={this.onChange}>
                            <Accordion.Panel header="主要表现">
                                <div style={{textIndent:'2em'}}>
                                抑郁症的三大主要症状也即是判断抑郁症的标准，很多人对抑郁症不陌生，但抑郁症与一般的"不高兴"有着本质区别，它有明显的特征，综合起来有三大主要症状，就是情绪低落、思维迟缓和运动抑制。
                                </div>
                                <ol style={{textIndent:'2em'}}>
                                    <li>1、情绪低落就是高兴不起来、总是忧愁伤感、甚至悲观绝望。</li>
                                    <li>2、思维迟缓就是自觉脑子不好使，记不住事，思考问题困难。患者觉得脑子空空、变笨了。</li>
                                    <li>3、运动抑制就是不爱活动，浑身发懒。走路缓慢，言语少等。严重的可能不吃不动，生活不能自理。</li>
                                </ol>
                            </Accordion.Panel>
                            <Accordion.Panel header="症状">
                                <div style={{textIndent:'2em'}}>
                                如果在一段时间(至少两周)内有以下的4种或以上症状，则你可能已患有产前抑郁症。如果其中的一或两种情况近期特别困扰你，则必须引起你的高度重视。
                                </div>
                                <div style={{textIndent:'2em'}}>
                                不能集中注意力，焦虑，极端易怒，睡眠不好，非常容易疲劳，或有持续的疲劳感，不停地想吃东西或者毫无食欲，对什么都不感兴趣，总是提不起精神，持续的情绪低落，想哭，情绪起伏很大，喜怒无常，经常想一些不太实东西。

                                </div>
                            </Accordion.Panel>
                            <Accordion.Panel header="引发原因">
                                <div style={{textIndent:'2em'}}>
                                据调查显示，有98%的孕妇在妊娠晚期会产生焦虑心理，有些人善于调节自己的情绪，会使焦虑心理减轻，有些人不善于调节，心理焦虑越来越重，造成这种心理问题有多种原因：
                                </div>
                                <ol style={{textIndent:'2em'}}>
                                    <li>1、怀孕后的女性往往最担心产后会失去怀孕前的一切，在丈夫里“失宠”,还担心自己身材会变形。</li>
                                    <li>2、中高收入女性在怀孕后马上辞退工作，原先充实的生活状态、明确的生活目的一下子就没了，人也变得很空虚，不做事情就东猜西想，猜想久了心理问题也就出来了。</li>
                                    <li>3、担心孩子出生后，自己的职业受到影响或家庭经济压力加大，而产生焦虑。</li>
                                    <li>4、患有妊娠高血压综合征、妊娠合并心脏病、妊娠合并心脏病等产前并发症的产妇，由于自身健康存在问题，同时也怕殃及胎儿，因此也易焦虑。</li>
                                </ol>
                            </Accordion.Panel>
                            <Accordion.Panel header="表现">
                                <div style={{textIndent:'2em'}}>
                                下面是产前抑郁症的症状。如果你有3种或更多以下症状，并持续2周以上，你就该找你的医生谈谈了，看你是否需要去接受心理治疗。
                                </div>
                                <ol style={{textIndent:'2em'}}>
                                    <li>1、觉得所有的事情都没有意思、没有乐趣。</li>
                                    <li>2、整天感觉沮丧、伤心，或“空荡荡的”，而且每天如此。</li>
                                    <li>3、难以集中精力。</li>
                                    <li>4、极端易怒或烦躁，或过多的哭泣。</li>
                                    <li>5、睡眠困难或睡眠过多。</li>
                                    <li>6、过度或从不间断的疲劳。</li>
                                    <li>7、总是想要吃东西或根本不想吃东西。</li>
                                    <li>8、不应该的内疚感，觉得自己没有用，没有希望。</li>
                                </ol>
                            </Accordion.Panel>
                            <Accordion.Panel header="专家建议">
                                <ol style={{textIndent:'2em'}}>
                                    <li>1、养成有规律的生活。饮食休闲要按部就班，从稳定的生活规律中领会自身的生活情趣。</li>
                                    <li>2、保持自己的外观整洁。自己的身体要保持清洁卫生，不得身穿邋遢的衣服，房间院落也要随时打扫干净。</li>
                                    <li>3、即使在抑郁状态下，也决不放弃自己的学习和工作。</li>
                                    <li>4、不得强压怒气，对人对事要宽宏大度。</li>
                                    <li>5、主动吸收新知识，做到“活到老学到老”。</li>
                                    <li>6、建立挑战意识，学会主动接受矛盾，解决矛盾，要有自信心，并相信自己能够成功。</li>
                                    <li>7、即使是小事，也要采取合乎情理的行动;即使你心情烦闷，仍要特别注意自己的言行，让自己合乎生活情理。</li>
                                    <li>8、培养自己的兴趣、爱好和特长，拓宽自己的兴趣范围。</li>
                                    <li>9、要积极的去尝试以前没有做过的事情，要积极的开辟新的生活园地，使自己的生活更充实。</li>
                                </ol>
                            </Accordion.Panel>
                        </Accordion>
                    </div>
...
export default withRouter(BYiyu);
