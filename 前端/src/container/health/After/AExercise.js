...
class AExercise extends Component {
    ...
    componentDidMount() {
        var title = '头颈部运动';
        fetch('http://localhost:5001/findaexercise', {
            method: 'POST',//post请求 
            headers: {
        ...
        return (
            <div style={{ width: '100%', height: '100%' }}>
                ...
                <div style={{ width: '17%', height: '800px', 
                        float:'left',
                        marginTop: '48px', backgroundColor: 'white'
                 }}>
                    <ul style={{ width: '100%' }}>
                        <li idx='0' onClick={(e) => { this.liChange(e) }} className='siderbar1'>头颈部运动</li>
                        <li idx='1' onClick={(e) => { this.liChange(e) }} className='siderbar'>腰部运动</li>
                        <li idx='2' onClick={(e) => { this.liChange(e) }} className='siderbar'>腿部运动</li>
                        <li idx='3' onClick={(e) => { this.liChange(e) }} className='siderbar'>臀部运动</li>
                        <li idx='4' onClick={(e) => { this.liChange(e) }} className='siderbar'>胸部运动</li>
                    </ul>
                </div>
                {/* content */}
                <div style={{
