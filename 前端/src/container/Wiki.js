...
class Parental extends Component {
    ...
    fushi=()=>{
        this.props.history.push('/wiki/topic/detail/25')
        // console.log(2);
    }
    render() {
        return (
            <div>
                <div>
                    ...
                    <NavBar
                        ...
                        rightContent={[
                            <Icon key="0" type="search" style={{ marginRight: '16px' }} onClick={this.handle1}/>,
                        ]}
                    >
                        百科知识
                    </NavBar>
                ...
                <div style={{ height: 120, border: 'solid 0.1px ', borderRadius: 20, background: 'white', padding: 10 }}>
                    ...
                    <Flex style={{marginTop:15}}>
                        <Flex.Item className='placeholder' style={{ background: 'url(./images/baike/back.png)' }} onClick={this.fushi}>宝宝辅食</Flex.Item>
