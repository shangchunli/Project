    ...
    return (
      <div style={{width:'70%',margin:'auto'}}>
              ...
              <List.Item ref='tabss'>
                <div onClick={() => this.getTab(1)} checked='false' id='21'
                  style={{
                    ...
                    backgroundColor: "#fff", width: "30%", height: 25
                  }}>常见疾病</div>
            ...
            <Accordion.Panel header="关于妈妈">
              <List.Item ref='tab2'>
                <div onClick={() => this.getTab1(1)} id='11'
                  style={{
                    textAlign: "center", float: "left",
                    backgroundColor: "#fff", width: "20%", height: 25,
                    marginLeft:'2.5%'
                  }}>产前锻炼</div>
                ...
                <div onClick={() => this.getTab1(6)} id='16'
                  style={{
                    textAlign: "center", float: "left",
                    backgroundColor: "#fff", width: "20%", height: 25,
                    marginLeft:'2.5%'
                  }}>产后抑郁</div>
                <div onClick={() => this.getTab1(7)} id='17'
                  style={{
                    textAlign: "center", float: "left",
                    backgroundColor: "#fff", width: "20%", height: 25,
                    marginLeft:'2.5%'
                  }}>产后焦虑</div>
                <div onClick={() => this.getTab1(8)} id='18'
                  style={{
                    textAlign: "center", float: "left",
                    backgroundColor: "#fff", width: "20%", height: 25,
                    marginLeft:'2.5%'
        ...
        <Button type="primary"
          ...
          style={{ backgroundColor: 'rgb(125,185,222)', marginTop: 20 }}
