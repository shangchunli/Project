    ...
    render() {
        ...
        return (
            ...
            style={{ 
              ...
              background: 'white', paddingTop:5,
              bottom: "0", width: "100%", height: "40px", color: "#2278c9" 
              }}
          >
            <div className="bottom">
              <Link to="/home">             
                  ...
                  <p className='bottom_a1' style={{color:''}}>首页</p>
            ...
            <div className="bottom">
              <Link to="/my">
                  <div style={{
                    ...
                    height: '22px',
                    marginLeft:'43%',
                    background: 'url(./images/my.svg) center center /  22px 22px no-repeat' }}
                  ></div>
