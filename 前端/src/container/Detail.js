                            ...
                            <div style={{ marginTop: 50 }}>
                                ...
                                <List.Item.Brief >
                                    <div style={{
                                        ...
                                        <input style={{ width: '40%', height: 30, borderRadius: 15, borderColor: 'rgb(245, 240, 240)', backgroundColor: 'white' }}
                                        ...
                                        />
                                        <span style={{ marginLeft: 10 }} onClick={this.crital}>
                                        ...
                                        {/* 收藏图标 */}
                                        <span style={{ marginLeft: 20, marginTop: 120 }} >
                                            <img
                                                ref='tab'
                                                id={item.chapterid}
                                                style={{ width: '5%' }}
                        ...
                        (this.state.tips || []).map(item =>
                            ...
                            >
                                <List.Item>
                                    ...
                                    <span style={{ marginLeft: '1%',display:'block' }} 
                                        onClick={() => { this.del(item.plid) }}>
                                        <img style={{display:'block',width:'22px',height:'22px',color:'red',position:'relative',left:'80%',top:'10%'}} 
                                        src='https://i.loli.net/2020/05/11/sWpCgexZzHkGVQF.png' />
